...
async def homepage(request):
    ...
    return web.Response(text="<h1>See mirror-leech-telegram-bot <a href='https://www.mjwebhacks.com'>@MJWebHacks</a> By <a href='https://mjwebhacks.com'>MJWebHacks</a></h1>", content_type="text/html")
